...
(function(__opal) {
  ...
  return (function(__base, __super){
    ...
    __opal.defs(Class, '$bridge_class', function(name, constructor) {
      
      return __opal.bridge(name, constructor);
    });
    ...
    def.$alias_native = function(mid, jsid) {
      ...
      return this.prototype['$' + mid] = this.prototype[jsid];
    };
...
(function(__opal) {
  ...
  return (function(__base){
    ...
    def.$method = function(name) {
      ...
      func.constructor = (($b = __scope.Method) == null ? __opal.cm("Method") : $b);
      return func;
    ...
    def.$printf = function(args) {
      var $a, $b, $c, $d, $e, fmt = nil;args = __slice.call(arguments, 0);
    ...
    def.$singleton_class = function() {
      ...
      if (this._singleton) {
        ...
        var orig_class = this.constructor,
    ...
    def.$to_s = function() {
      ...
      return "#<" + this.constructor._name + ":" + this._id + ">";
    };
...
(function(__opal) {
  ...
  return (function(__base){
    ...
    var def = Enumerable.prototype, __scope = Enumerable._scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_17, TMP_18, TMP_19;
    ...
    def.$group_by = TMP_14 = function() {
      var TMP_15, $a, $b, $c, TMP_16, block, hash = nil;
...
if (k == null) k = nil;
    ...
    def.$inject = def.$reduce;
        ;__opal.donate(Enumerable, ["$all?", "$any?", "$collect", "$reduce", "$count", "$detect", "$drop", "$drop_while", "$each_slice", "$each_with_index", "$each_with_object", "$entries", "$find", "$find_all", "$find_index", "$first", "$grep", "$group_by", "$map", "$max", "$min", "$none?", "$select", "$take", "$to_a", "$inject"]);
  })(self)
})(Opal);
(function(__opal) {
  var self = __opal.top, __scope = __opal, nil = __opal.nil, $mm = __opal.mm, __breaker = __opal.breaker, __slice = __opal.slice, __klass = __opal.klass;
...
(function(__opal) {
  ...
  return (function(__base, __super){
    ...
    def.$each = TMP_1 = function() {
      var $a, $b, $c, $d, $e, $f, block, current = nil;
      block = TMP_1._p || nil, TMP_1._p = null;
...
(function(__opal) {
  var self = __opal.top, __scope = __opal, nil = __opal.nil, $mm = __opal.mm, __breaker = __opal.breaker, __slice = __opal.slice, __klass = __opal.klass, days_of_week = nil, short_days = nil, short_months = nil, long_months = nil;
...
(function(__opal) {
  var $a, $b, $c, $d, $e, self = __opal.top, __scope = __opal, nil = __opal.nil, $mm = __opal.mm, def = self.constructor.prototype, __breaker = __opal.breaker, __slice = __opal.slice, __gvars = __opal.gvars, __hash2 = __opal.hash2;
